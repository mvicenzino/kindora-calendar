...
- [Calendar member de-duplication](calendar-member-dedup.md) — never backfill members on read; link accounts to existing rows only on unambiguous name match; merge deletes sources before inheriting user_id.
