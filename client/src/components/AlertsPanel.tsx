...
export default function AlertsPanel() {
  ...
  const panelContent = isOpen ? createPortal(
    <>
      ...
      <div
        ref={panelRef}
        className="fixed right-2 sm:right-4 top-14 w-[calc(100vw-1rem)] sm:w-96 max-h-[calc(100vh-5rem)] bg-slate-950/98 border border-white/20 rounded-2xl shadow-2xl flex flex-col backdrop-blur-xl"
        style={{ zIndex: 99999 }}
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 flex-shrink-0">
          ...
          <button
            onClick={handleClose}
            className="text-white/50 p-1.5 rounded-lg hover-elevate"
              ...
              {alerts.todayEvents.map(event => (
                ...
                >
                  ...
                  <button
                    ...
                    className="text-white/30 p-1 rounded-lg flex-shrink-0 hover-elevate"
