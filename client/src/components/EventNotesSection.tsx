...
export default function EventNotesSection({ eventId, familyId, currentUserId }: EventNotesSectionProps) {
          ...
          <div className="ml-6 mb-3">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="bg-purple-600 hover:bg-purple-700 h-[60px] w-10"
