...
export default function Header({ onMessagesClick, onProfileClick }: HeaderProps) {
  return (
    <header className="w-full px-3 sm:px-4 md:px-6 py-3 sm:py-4 backdrop-blur-xl bg-white/5 border-b border-white/10 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Left: App branding */}
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-10 h-10 rounded-xl sm:rounded-2xl bg-gradient-to-br from-white/40 to-white/20 border-2 border-white/50 flex items-center justify-center shadow-lg">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              className="w-6 h-6"
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-white leading-none">FamilyCal</h1>
