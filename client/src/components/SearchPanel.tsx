...
export default function SearchPanel({ isOpen, onClose, events, onSelectEvent }: SearchPanelProps) {
  ...
  return (
    <>
      ...
      >
        <div className="backdrop-blur-xl bg-card/95 border-b border-border shadow-2xl">
          <div className="max-w-4xl mx-auto px-4 md:px-6 py-6">
            ...
            <div className="flex gap-3 items-center mb-4">
              ...
              <button
                onClick={onClose}
                className="w-10 h-10 rounded-lg bg-muted/50 border border-border flex items-center justify-center text-foreground hover-elevate transition-all"
                ...
                {filteredEvents.length === 0 ? (
                  ...
                  filteredEvents.map((event) => (
                    <button
                      ...
                      className="w-full text-left bg-muted/50 hover-elevate border border-border rounded-lg p-3 transition-colors cursor-pointer"
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          {event.description && (
                            <p className="text-muted-foreground text-sm truncate">{event.description}</p>
                          )}
