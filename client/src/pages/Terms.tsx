    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-muted/50 border-b border-border px-4 md:px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold text-foreground font-['Space_Grotesk']">Terms of Service</h1>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12">
        <div className="backdrop-blur-xl bg-card border border-border rounded-md p-6 md:p-10 text-foreground space-y-6">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">3. Account Registration</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">4. User Responsibilities</h3>
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">5. Family & Caregiver Access</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">6. Health & Medical Information</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">8. Third-Party Services</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">10. Disclaimer of Warranties</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="space-y-3">
            <h3 className="text-lg font-semibold text-foreground">11. Termination</h3>
            <p className="text-muted-foreground leading-relaxed">
